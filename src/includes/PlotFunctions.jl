...
module PlotFunctions
	...
	"""
	    plotStages(file, axes; starttime=DateTime(0),  endtime=DateTime(0), CLOUDruntable = true, headerrow = 1, textoffset = 0.75, vlinecolor = \"k\")
	...
	"""
	function plotStages(file, axes; starttime=DateTime(0),  endtime=DateTime(0), CLOUDruntable = true, headerrow = 1, textoffset = 0.75, vlinecolor = "k")
